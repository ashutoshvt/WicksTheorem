...
#nmo, nocc, frozen_occ, H, MO, memory=2
class HelperCCEnergy(object):
    def __init__(self, nmo, nocc, frozen_occ, H, MO, F, memory=2):
        ...
        self.nmo = nmo
        self.nocc = nocc 
        self.naocc = self.nocc - frozen_occ
        ...
        # Make slices
        self.slice_o = slice(frozen_occ, self.nocc)
        ...
        # t^a_i
        self.t1 = np.zeros((self.naocc, self.nvirt))
        # t^{ab}_{ij}
...
if __name__ == "__main__":
    ...
    ccsd = HelperCCEnergy(nmo, nocc, frozen_occ, scf.H, scf.MO, scf.F, memory=2)
